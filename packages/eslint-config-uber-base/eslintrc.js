module.exports = {
  ...
  /**
   * All formatting will eventually be dictated by prettier
   * Additionally, some errors will be caught with Flow
   * For now, let's just set up some basic lint rules to catch common problems
   */
  rules: {
    ...
    'prettier/prettier': ['error', {
      ...
      /**
       * For consistency, use babylon parser
       */
      parser: 'babylon'
    }],
    ...
    /**
     * Never allow using undefined variables
     */
    'no-undef': 'error',
    /**
